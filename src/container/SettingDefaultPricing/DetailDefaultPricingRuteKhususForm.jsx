...
export default function DetailDefaultPricingRuteKhususForm({
  id,
  onDataChange,
}) {
  const {
    ...
    defaultValues: {
      coltDieselEngkel: "100",
      coltDieselDouble: "150",
      mediumTruckRigid4x2: "200",
      mediumTruck6x2Rigid: "250",
      mediumTruckRigid6x4: "300",
      mediumTruck4x2Gandengan: "350",
      tractorHead4x2SemiTrailer: "400",
      tractorHead6x4SemiTrailer: "450",
