  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <CollapsiblePrimitive.Trigger
        ref={ref}
        className={cn(
          "!hover:none flex !h-11 w-full items-center justify-between !rounded-[10px] !border !bg-[#D1E2FD] py-4 !ps-[34px] !text-xl !text-[#176CF7] transition-all hover:no-underline [&>span]:!font-semibold [&[data-state=open]>svg]:rotate-180 [&>svg]:!text-gray-600",
          className
        )}
        {...props}
      >
