...
import { SimpleDropdownMenuContentProps, SimpleDropdownItemProps } from "./SimpleDropdownMenu.types";
 ...
 */
export const SimpleDropdownItem = ({ className, onClick, children }: SimpleDropdownItemProps) => (
