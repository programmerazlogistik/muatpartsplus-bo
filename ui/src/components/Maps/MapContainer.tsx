/**
 * @typedef {import('./MapContainer.d.ts').MapContainerProps} MapContainerProps
 * @typedef {import('./MapContainer.d.ts').MapCoordinates} MapCoordinates
 */
 ...
 * @returns {React.ReactElement} MapContainer component
 */
