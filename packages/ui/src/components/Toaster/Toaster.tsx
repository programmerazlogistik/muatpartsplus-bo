 ...
 * @param {ToasterProps} props - Component props
 * @returns {JSX.Element|null} Rendered Toaster component or null if not mounted
 */
  ...
  return (
    <Portal>
      <div
        ...
        style={{
          bottom:
            bottomOffset !== undefined ? bottomOffset : calculatedBottomOffset,
        }}
        role="region"
        ...
        {dataToast.map((toast, index) => (
          <div
            ...
            className={cn(
              ...
              "text-xs font-semibold leading-[1.2] tracking-tight text-neutral-900",
