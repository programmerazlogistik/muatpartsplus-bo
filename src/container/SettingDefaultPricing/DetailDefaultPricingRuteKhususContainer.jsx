...
import DetailDefaultPricingRuteKhususForm from "./DetailDefaultPricingRuteKhususForm";

export default function DetailDefaultPricingRuteKhususContainer({ id }) {
  ...
  return (
    <>
        ...
        <div className="flex items-center space-x-4">
          ...
          >
            ...
            <span className="text-xl font-semibold">
              Detail Default Pricing Rute Khusus
            </span>
          </button>
        </div>
      ...
      <div>
        <DetailDefaultPricingRuteKhususForm
          id={id}
