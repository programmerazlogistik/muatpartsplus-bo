/**
 * @typedef {import('./multilevel-select.d.ts').MultilevelSelectProps} MultilevelSelectProps
 */
import { useEffect, useRef, useState } from "react";

import { useShallowMemo } from "@muatmuat/hooks/use-shallow-memo";
...
/**
 * A two-level cascading dropdown component that displays hierarchical options
 * with radio button selection.
 *
 * @param {MultilevelSelectProps} props - Component props
 * @returns {React.ReactElement}
 */
const MultilevelSelectImplementation = ({
  options,
  value,
  onChange,
  disabled,
        ...
        {options.map((option, key) => {
          ...
          return (
            <div
              ...
              onClick={() => !hasChildren && handleSelect(option, null)}
            >
...
MultilevelSelectImplementation.displayName = "MultilevelSelect";

export default MultilevelSelectImplementation;
