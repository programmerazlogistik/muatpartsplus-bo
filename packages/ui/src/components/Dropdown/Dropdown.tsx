...
/**
 * Dropdown root component built on Radix UI Popover primitive.
 * Provides the foundation for all dropdown interactions.
 * @type {typeof PopoverPrimitive.Root}
 */
const Root = PopoverPrimitive.Root;
/**
 * Dropdown trigger component built on Radix UI Popover primitive.
 * Wraps the element that triggers the dropdown content.
 * @type {typeof PopoverPrimitive.Trigger}
 */
const Trigger = PopoverPrimitive.Trigger;

/**
 * Filter trigger component with active state styling.
 * Specialized trigger for filter dropdowns with visual state indicators.
 */
...
/**
 * Dropdown content component with animations and positioning.
 * Renders the main dropdown container with proper styling.
 */
...
/**
 * Hover root component for nested dropdown functionality.
 * Triggers submenus on hover with proper timing and accessibility.
 */
...
/**
 * Hover content component for nested dropdown submenus.
 * Renders submenu content with scrolling and positioning.
 */
...
/**
 * Hover item component for nested dropdown items.
 * Individual clickable items within hover submenus.
 */
...
const Dropdown: DropdownComponents = {
  Root,
  Trigger,
  FilterTrigger,
  Content,
