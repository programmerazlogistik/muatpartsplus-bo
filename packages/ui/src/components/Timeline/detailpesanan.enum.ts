...
export const getOrderStatusRank = (orderStatus: string): number => {
  return Object.values(OrderStatusEnum).indexOf(orderStatus);
};

export const OrderStatusTitle: Record<string, string> = {
...
export const OrderStatusIcon: Record<string, string> = {
  ...
  [OrderStatusEnum.CANCELED_BY_SYSTEM]: "/icons/close-circle.svg",
  [OrderStatusEnum.CANCELED_BY_SHIPPER]: "/icons/close-circle.svg",
  [OrderStatusEnum.CANCELED_BY_TRANSPORTER]: "/icons/close-circle.svg",
};
