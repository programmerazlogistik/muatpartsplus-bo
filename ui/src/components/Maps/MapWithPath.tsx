/**
 * @typedef {import('./MapWithPath.d.ts').MapWithPathProps} MapWithPathProps
 * @typedef {import('./MapWithPath.d.ts').LocationMarker} LocationMarker
 * @typedef {import('./MapWithPath.d.ts').LatLng} LatLng
 */
 ...
 *
 * @param {MapWithPathProps} props - Component props
 * @returns {React.ReactElement} MapWithPath component
 */
